 ...
 * @param  {String} data.installation The installation instructions of the game being created.
 * @return {Promise}
 */
 ...
 * @param  {String} data.download The download link for the application compatible with this new version.
 * @return {Promise}
 */
